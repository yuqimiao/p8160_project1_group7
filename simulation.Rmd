...
* beta : true beta. If beta is not specified, beta will be sample by formulas of c
...
simulation <- function(n, p, percentage, c = 1, mu = 1, sigma = 0.5, beta = NULL, seed = 100, error_sigma = 1){
  ...
  # collect output
  result = list(beta = beta_result, data = data, response = response, c = c, percentage = c(strong, weak_corr, weak_no_corr))
  return(result)
}
